...
#define TIM4_ENABLE() TIM4_CR1 |= M1(CR1_CEN)
#define TIM4_DISABLE() TIM4_CR1 &= ~M1(CR1_CEN)

#define TIM4_AUTO_RELOAD_PRELOAD_ENABLE() TIM4_CR1 |= M1(CR1_ARPE)
...
#define TIM4_INT_ENABLE() TIM4_IER |= M1(IER_UIE)
#define TIM4_INT_DISABLE() TIM4_IER &= ~M1(IER_UIE)
#define TIM4_INT_CLEAR() TIM4_SR &= ~M1(SR_UIF)
